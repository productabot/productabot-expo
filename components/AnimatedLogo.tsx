...
export function AnimatedLogo({ loading = true, size = 1 }) {
    ...
    return (
        <View style={{ width: 28 * size, height: 28 * size, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', backgroundColor: '#000000', borderColor: '#ffffff', borderWidth: 1, borderRadius: 5 * size, marginLeft: size !== 1 ? 5 : 15, marginRight: 5, padding: 2 * size, paddingLeft: 2 * size, paddingRight: 2 * size }}>
            <View style={{ flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-around', width: '100%' }}>
                <Animated.View style={{ borderRadius: 10 * size, height: height1, width: 2 * size, backgroundColor: '#ffffff' }} />
                <Animated.View style={{ borderRadius: 10 * size, height: height2, width: 2 * size, backgroundColor: '#ffffff' }} />
                <Animated.View style={{ borderRadius: 10 * size, height: height3, width: 2 * size, backgroundColor: '#ffffff' }} />
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-around', width: '100%', paddingTop: 2 * size, paddingBottom: 2 * size }}>
                <Animated.View style={{ borderRadius: 10 * size, height: 2 * size, width: 2 * size, backgroundColor: '#ffffff' }} />
                <Animated.View style={{ borderRadius: 10 * size, height: 2 * size, width: 2 * size, backgroundColor: '#ffffff' }} />
                <Animated.View style={{ borderRadius: 10 * size, height: 2 * size, width: 2 * size, backgroundColor: '#ffffff' }} />
            </View>
        </View>
