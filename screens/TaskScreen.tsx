    ...
    return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingTop: Platform.OS === 'web' ? 50 : 0, }}>
            <View style={{ width: Math.min(600, windowDimensions.width), height: windowDimensions.height - (Platform.OS === 'web' ? 80 : 150) }}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 15, margin: 10, marginBottom: 0, borderRadius: 10, backgroundColor: '#161616' }}>
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => (
                        <TouchableOpacity
                            ...
                            style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 15, margin: 10, marginBottom: 0, borderRadius: 10, backgroundColor: '#161616' }}>
